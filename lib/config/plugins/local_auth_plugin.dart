  ...
  static Future<(bool, String)> authenticate({
    ...
    try {
      final bool didAuthenticate = await auth.authenticate(
        localizedReason: 'Por favor autenticate para iniciar sesión',
        options: AuthenticationOptions(
          biometricOnly: biometricOnly, // false podemos colocar PIN
        ),
      );
      return (
        didAuthenticate,
      ...
      if (e.code == auth_error.permanentlyLockedOut) {
        return (false, 'Se require desbloquear el teléfono');
      }
